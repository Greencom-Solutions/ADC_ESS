...
{
    public class SpecialImprestController : Controller
    {
        // GET: SpecialImprest
        public ActionResult SpecialImprestList()
        {
            try
            {
        ...
        public PartialViewResult SpecialImprestListPartialView()
        {
            try
            {
                ...
                var ImpList = new List<SpecialImprest>();

                var role = Session["ESSRoleSetup"] as ESSRoleSetup;
                var page = $"SpecialImprestWarranty?$filter=Account_No eq '{StaffNo}'&$format=json";
                ...
                using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                {
                    ...
                    foreach (JObject config in details["value"])
                    {
                        var ImList = new SpecialImprest
                        {
                            ...
                            Reasons_to_Reopen = (string)config["Reasons_to_Reopen"]
                ...
                return PartialView("~/Views/SpecialImprest/PartialViews/SpecialImprestListPartialView.cshtml", ImpList.OrderByDescending(x => x.No));
            }
            catch (Exception ex)
            {
                var erroMsg = new Error
        ...
        [HttpPost]
        public ActionResult SpecialImprestDocumentView(string DocNo)
        {
            try
            {
        ...
        public PartialViewResult SpecialImprestLines(string DocNo, string Status)
        {
            try
            {
                ...
                return PartialView("~/Views/SpecialImprest/PartialViews/SpecialImprestLines.cshtml", ImpLines);
            }
            catch (Exception ex)
            {
                var erroMsg = new Error
        ...
        public ActionResult NewSpecialImprestRequest()
        {
            try
            {
                if (Session["Username"] == null) return RedirectToAction("Login", "Login");
                var employeeView = Session["EmployeeData"] as EmployeeView;
                var StaffNo = Session["Username"].ToString();
                var NewSpecialImprest = new SpecialImprest();
                string Dim1 = employeeView.GlobalDimension1Code;
                string Dim2 = employeeView.GlobalDimension2Code;

                NewSpecialImprest.Shortcut_Dimension_2_Code = employeeView.GlobalDimension2Code;
                ...
                NewSpecialImprest = new SpecialImprest
                {
                ...
                return View("~/Views/SpecialImprest/PartialViews/NewSpecialImprestRequest.cshtml", NewSpecialImprest);
        ...
        public ActionResult SubmitSpecialImprestRequisition(SpecialImprest data)
        {
            ...
            try
            {
                ...
                DocNo = Credentials.ObjNav.InsertSpecialImprest(StaffNo, data.Payment_Narration);
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult UpdateSpecialImprestHeader(string DocNo, SpecialImprest SpecialImprestHeader)
        {
            try
            {
                ...
                var res = Credentials.ObjNav.ModifySpecialImprest(
                    DocNo,
                    StaffNo,
                    SpecialImprestHeader.Payment_Narration 
                );
        ...
        public ActionResult NewSpecialImprestLine(string docNo)
        {
            try
            {
                var specialImprestLine = new StandingImprestLine();
                ...
                specialImprestLine.ListOfEmployees = EmpList.Select(x =>
                      new SelectListItem
                      {
                          Text = x.Text,
                          Value = x.Value
                ...
                specialImprestLine.ListOfDim1 = Dim1List.Select(x =>
                      new SelectListItem
                      {
                          Text = x.Text,
                          Value = x.Value
                ...
                specialImprestLine.ListOfDim2 = Dim2List.Select(x =>
                      new SelectListItem
                      {
                          Text = x.Text,
                          Value = x.Value
                      }).ToList();
                specialImprestLine.ListOfGl = GlList.Select(x =>
                      new SelectListItem
                      {
                          Text = x.Text,
                          Value = x.Value
                      }).ToList();
                specialImprestLine.ListOfBanks = BankList.Select(x =>
                      new SelectListItem
                      {
                          Text = x.Text,
                          Value = x.Value
                ...
                return PartialView("~/Views/SpecialImprest/PartialViews/NewSpecialImprestLine.cshtml", specialImprestLine);
            }
            catch (Exception ex)
            {
                var erroMsg = new Error();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult SubmitSpecialImprestLine(string DocNo, StandingImprestLine ImpLine)
        {
            try
            {
                var UserID = Session["UserID"].ToString();
        ...
        public PartialViewResult SpecialImprestItems(string DocNo, string Status)
        {
            try
            {
                #region Imp Lines
        ...
        public PartialViewResult SpecialImprestNonStaff(string DocNo, string Status)
        {
            try
            {
                #region Imp Lines
        ...
        public JsonResult DeleteSpecialImprestLine(string DocNo, int LineNo)
        {
            try
            {
        ...
        public JsonResult SendSpecialImprestAppForApproval(string DocNo)
        {
            try
            {
                var UserID = Session["UserID"].ToString();
        ...
        public JsonResult CancelSpecialImprestAppForApproval(string DocNo)
        {
            try
            {
                var UserID = Session["UserID"].ToString();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult SubmitSpecialImprestItem(string DocNo, ImprestMemoLines ImprestMemoLine)
        {
            try
            {
                var StaffNo = Session["Username"].ToString();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult SubmitSpecialImprestNonStaff(string DocNo, string Names, string Organization, string Designation)
        {
            try
            {
                var StaffNo = Session["Username"].ToString();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult UpdateSpecialImprestLine(string DocNo, ImprestMemoLines ImprestMemoLine)
        {
            try
            {
                var StaffNo = Session["Username"].ToString();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public PartialViewResult EditSpecialImprestLine(string LnNo, string DocNo)
        {
            try
            {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public JsonResult RemoveSpecialImprestLine(string DocNo, string LnNo)
        {
            try
            {
        ...
        public JsonResult RemoveSpecialImprestNonstaff(string DocNo, string LnNo)
        {
            try
            {
